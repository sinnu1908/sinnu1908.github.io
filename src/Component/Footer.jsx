        ...
        >
          <Box p={{ base: "0", sm: "25px" }}>
            ...
            <Flex mt="15px" justify="start">
              ...
              <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <a target="_blank" href="https://accounts.google.com/v3/signin/identifier?dsh=S1325626027%3A1690360974324875&continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&ifkv=AeDOFXh_BToVub-h5Vm4oHeKNoM_6fipBlrzBPkaCCz5-Y0996_LrJf8Pv5tWwuCrzSmUT3eyv9rPw&rip=1&sacu=1&service=mail&flowName=GlifWebSignIn&flowEntry=ServiceLogin">
                  <Text
                    fontSize="sm"
                    color="#00796B"
                    fontWeight="500"
            ...
            <Flex mt="25px">
              ...
              <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <a
                  target="_blank"
                  href="https://www.linkedin.com/in/shrinivas-katkamwar-721656241/"
                >
                  <Text
                    id="contact-linkedin"
                    fontSize="sm"
            ...
            <Flex mt="25px">
              ...
              <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                <a target="_blank" href="https://github.com/sinnu1908">
                  <Text
                    id="contact-github"
                    fontSize="sm"
                    color="#00796B"
